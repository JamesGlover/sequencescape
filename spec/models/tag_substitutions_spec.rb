...
describe TagSubstitution do
  ...
  context 'with a simple tag swap' do
    ...
    let!(:library_aliquot_a) { create :aliquot, sample: sample_a, tag: sample_a_orig_tag, tag2: sample_a_orig_tag2, library: library_tube_a, receptacle: library_tube_a.receptacle }
    let!(:library_aliquot_b) { create :aliquot, sample: sample_b, tag: sample_b_orig_tag, tag2: sample_b_orig_tag2, library: library_tube_b, receptacle: library_tube_b.receptacle }
    let!(:mx_aliquot_a) { create :aliquot, sample: sample_a, tag: sample_a_orig_tag, tag2: sample_a_orig_tag2, library: library_tube_a, receptacle: mx_library_tube.receptacle }
    let!(:mx_aliquot_b) { create :aliquot, sample: sample_b, tag: sample_b_orig_tag, tag2: sample_b_orig_tag2, library: library_tube_b, receptacle: mx_library_tube.receptacle }
    let!(:mx_aliquot_c) { create :tagged_aliquot, library: library_tube_b, receptacle: mx_library_tube.receptacle }

    let!(:lane) { create :lane }
    let!(:lane_aliquot_a) { create :aliquot, sample: sample_a, tag: sample_a_orig_tag, tag2: sample_a_orig_tag2, library: library_tube_a, receptacle: lane.receptacle }
  ...
  context 'with a multi-tag sample tag swap' do
    ...
    # Build aliquots
    let!(:library_aliquot_a_a) { create :aliquot, sample: sample_a, tag: sample_a_orig_tag_a, library: library_tube_a, receptacle: library_tube_a.receptacle }
    let!(:library_aliquot_a_b) { create :aliquot, sample: sample_a, tag: sample_a_orig_tag_b, library: library_tube_a, receptacle: library_tube_a.receptacle }
    let!(:library_aliquot_b_a) { create :aliquot, sample: sample_b, tag: sample_b_orig_tag_a, library: library_tube_b, receptacle: library_tube_b.receptacle }
    let!(:library_aliquot_b_b) { create :aliquot, sample: sample_b, tag: sample_b_orig_tag_b, library: library_tube_b, receptacle: library_tube_b.receptacle }
    let!(:mx_aliquot_a_a) { create :aliquot, sample: sample_a, tag: sample_a_orig_tag_a, library: library_tube_a, receptacle: mx_library_tube.receptacle }
    let!(:mx_aliquot_a_b) { create :aliquot, sample: sample_a, tag: sample_a_orig_tag_b, library: library_tube_a, receptacle: mx_library_tube.receptacle }
    let!(:mx_aliquot_b_a) { create :aliquot, sample: sample_b, tag: sample_b_orig_tag_a, library: library_tube_b, receptacle: mx_library_tube.receptacle }
    let!(:mx_aliquot_b_b) { create :aliquot, sample: sample_b, tag: sample_b_orig_tag_b, library: library_tube_b, receptacle: mx_library_tube.receptacle }
