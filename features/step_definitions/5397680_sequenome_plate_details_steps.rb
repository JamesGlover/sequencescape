Given /^I have created a sequenom plate$/ do
  ...
  Given %Q{there is a 1 well "Working Dilution" plate with a barcode of "6250125054875"}
  And %Q{there is a 1 well "Working Dilution" plate with a barcode of "6250125056664"}
  ...
  Given %Q{plate with barcode "6250125054875" belongs to study "Study A"}
  And %Q{plate with barcode "6250125056664" belongs to study "Study A"}
  And %Q{plate with barcode "1220125069815" belongs to study "Study B"}
  And %Q{plate with barcode "1220125048766" belongs to study "Study B"}
